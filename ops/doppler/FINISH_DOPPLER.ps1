...
# Check gh authentication (will fail later if not authenticated)
# Note: User is authenticated via keyring, warnings about GH_TOKEN can be ignored
...
Write-Host "  Press Enter once you have added the secret..." -ForegroundColor Yellow
$null = Read-Host
...
Write-Host "`nNext: Monitor CI run and verify Env check PASS appears." -ForegroundColor Yellow
